...
namespace GooglePlayGames.Editor
{
    ...
    public class NearbyConnectionUI : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            mNearbyServiceId = EditorGUILayout.TextField(
                GPGSStrings.Setup.NearbyServiceId,
                mNearbyServiceId,
                GUILayout.Width(350));
        ...
        private void DoSetup()
        {
            if (PerformSetup(mNearbyServiceId, true))
            {
                EditorUtility.DisplayDialog(
                    GPGSStrings.Success,
                    GPGSStrings.NearbyConnections.SetupComplete,
                    GPGSStrings.Ok);
                this.Close();
            }
        }
        ...
        public static bool PerformSetup(string nearbyServiceId, bool androidBuild)
        {
            ...
            if (androidBuild)
            {
                ...
                // ✅ Fixed call: pass class name as string
